module ColumnType
  ...
  type, public :: column_type
     ...
     integer,  pointer :: hillslope_elevzone   (:)   ! hillslope elevation zone identifier
...
contains
  ...
  subroutine Init(this, begc, endc)
    ...
    allocate(this%hillslope_elevzone(begc:endc))               ; this%hillslope_elevzone (:) = ispval
  ...
  subroutine Clean(this)
    ...
    deallocate(this%hillslope_elevzone)
